...
export function SiteHeader() {
  return (
    <header className="site-header inner-header">
      <nav className="header-nav header-nav-primary" aria-label="Download SlushIQ"><a className="header-download ios" href="https://apps.apple.com/us/app/slushiq/id6749187530" target="_blank" rel="noreferrer">Download on iOS</a><a className="header-download android" href="https://play.google.com/store/apps/details?id=com.slushiq.app" target="_blank" rel="noreferrer">Download on Android</a></nav>
