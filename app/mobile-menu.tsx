    ...
    <div className={`mobile-menu ${open ? "is-open" : ""}`}>
      ...
      <nav id="mobile-site-menu" className="mobile-menu-panel" aria-label="Mobile navigation">
        ...
        <div className="mobile-menu-downloads">
          <a href={appStore} target="_blank" rel="noreferrer" onClick={close} aria-label="Download SlushIQ on the App Store" data-analytics-event="app_store_click" data-analytics-placement="mobile_menu"><img src="/app-store-badge.svg" width="120" height="40" alt="Download on the App Store" /></a>
          <a href={playStore} target="_blank" rel="noreferrer" onClick={close} aria-label="Get SlushIQ on Google Play" data-analytics-event="google_play_click" data-analytics-placement="mobile_menu"><img src="/google-play-badge.png" width="478" height="142" alt="Get it on Google Play" /></a>
        </div>
      </nav>
