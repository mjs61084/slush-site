...
export function StorePicker({ appStore, playStore }: { appStore: string; playStore: string }) {
  ...
  return <div className="smart-store-picker">
    ...
    <details className={`store-picker ${detectedUrl ? "has-detected" : ""}`}>
      ...
      <div className="store-picker-menu"><p>{detectedUrl ? "Choose another device" : "Choose your device"}</p><a href={appStore} target="_blank" rel="noreferrer" data-analytics-event="app_store_click" data-analytics-placement="store_picker"><img src="/app-store-badge.svg" width="120" height="40" alt="Download on the App Store" /></a><a href={playStore} target="_blank" rel="noreferrer" data-analytics-event="google_play_click" data-analytics-placement="store_picker"><img src="/google-play-badge.png" width="478" height="142" alt="Get it on Google Play" /></a></div>
    </details>
  </div>;
}
