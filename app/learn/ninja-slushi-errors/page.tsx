...
export const metadata: Metadata = {
  title: "Slush Machine Alerts & Troubleshooting Guide",
  description: "Understand common slush machine sugar and alcohol alerts, what mixture problems to check, and when to stop troubleshooting and contact the manufacturer.",
  alternates: { canonical: url },
  openGraph: { title: "Slush Machine Alerts & Troubleshooting Guide", description: "A practical guide to mixture alerts, liquid batches, hard freeze, and repeated machine warnings.", url, type: "article" },
};
export default function ErrorGuide() {
  const schema = { "@context": "https://schema.org", "@type": "Article", headline: "Slush Machine Alerts and Troubleshooting Guide", description: metadata.description, author: { "@type": "Organization", name: "SlushIQ" }, publisher: { "@type": "Organization", name: "SlushIQ" }, mainEntityOfPage: url };
  return <GuideShell kicker="MACHINE ALERTS" title="Read the signal." accent="Then check the whole batch."
    ...
    sectionHeading="What to check before changing anything" sections={[
      { title: "Write down the exact alert and model", body: "Alert wording, lights, sounds, and supported ranges can differ by machine. Record the model number and consult its owner’s guide rather than relying on advice for a different version." },
    ...
    safetyHeading="When to contact the manufacturer"
