...
export default function SugarFreeGuide() {
  ...
  return <GuideShell kicker="SUGAR-FREE SLUSH" title="Diet drinks need" accent="a different freeze plan."
    ...
    sectionHeading="Why sugar-free batches behave differently" sections={[
      ...
      { title: "Allulose behaves more like a bulk sugar", body: "Allulose contributes dissolved solids and lowers the freezing point, which is why it is commonly used in sugar-free slush mixtures. Liquid and granular products may have different concentrations, so tablespoons are not automatically interchangeable." },
