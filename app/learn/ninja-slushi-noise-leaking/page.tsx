...
export default function NoiseGuide() {
  ...
  return <GuideShell kicker="MACHINE TROUBLESHOOTING" title="A new sound is" accent="worth a careful check."
    ...
    calloutBody="If a removable component is cracked, warped, rubbing, or will not seat normally, continuing operation may worsen the damage. Replacement parts and warranty decisions should come from the manufacturer."
    ...
    links={[{ href: "/learn/ninja-slushi-errors", label: "Machine alerts and troubleshooting" }, { href: "/learn/fix-my-slush", label: "Separate machine trouble from mixture trouble" }, { href: "/support", label: "SlushIQ app support" }]} schema={schema} />;
}
