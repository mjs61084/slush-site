...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://slushiq.com/brixley" },
};
...
export default function BrixleyPage() {
  return <><SiteHeader /><main className="brixley-page">
    <section className="brixley-hero">
      ...
      <BrixleyImage alt="Brixley, the SlushIQ AI frozen drink assistant" sizes="(max-width: 800px) 240px, 390px" priority />
    </section>
    ...
    <section className="brixley-walkthrough">
      ...
      <div className="brixley-page-flow" aria-label="Brixley troubleshooting walkthrough">
        <figure><AppScreenshot src="/brixley-flow-start.png" alt="Brixley collecting an ingredient and amount" /><figcaption><span>01</span><b>Tell Brixley what went in</b><small>Work through each ingredient, amount, and the information Brixley needs to evaluate it.</small></figcaption></figure>
        <figure><AppScreenshot src="/brixley-flow-review.png" alt="Brixley reviewing the complete frozen drink mix" /><figcaption><span>02</span><b>Review the complete mix</b><small>Confirm the batch before the freeze analysis begins.</small></figcaption></figure>
        <figure><AppScreenshot src="/brixley-flow-fix.png" alt="Brixley recommending a measured fix for a slush batch" /><figcaption><span>03</span><b>Get a measured next step</b><small>Add a specific adjustment instead of pouring and hoping.</small></figcaption></figure>
      </div>
    </section>
